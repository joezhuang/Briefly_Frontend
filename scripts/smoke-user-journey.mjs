...
const checks = [
  ...
  {
    name: "Local stories stay inside Briefly before opening original coverage",
  ...
  {
    name: "Local story routes delegate generation to the shared-feed cost policy",
  ...
  },
  {
    ...
    needles: [
      ...
      'article.generation_status === "source_only"',
      "copy.sourceOnlyBody",
      "openCoverage(item.url, item.source, item.language)",
    ],
  },
  {
