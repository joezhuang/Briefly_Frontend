...
const copy = {
  en: {
    ...
    upgradeSubtitle: "Unlock article translations across supported languages.",
    monthly: "Monthly",
    yearly: "Yearly",
  ...
  es: {
    ...
    upgradeSubtitle: "Desbloquea traducciones de artículos en los idiomas compatibles.",
    monthly: "Mensual",
    yearly: "Anual",
  ...
  ja: {
    ...
    upgradeSubtitle: "対応言語の記事翻訳を利用できます。",
    monthly: "月額",
    yearly: "年額",
