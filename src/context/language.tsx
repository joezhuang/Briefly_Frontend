...
const copy = {
  en: {
    ...
    signInTitle: "Sign in to Briefly",
    signInSubtitle: "Use your existing Briefly / Deeply account.",
    ...
    alreadyPro: "You already have Briefly Pro.",
    themeSystem: "System",
    themeLight: "Light",
    themeDark: "Dark",
  },
  es: {
    ...
    signInTitle: "Inicia sesión en Briefly",
    signInSubtitle: "Usa tu cuenta existente de Briefly / Deeply.",
    ...
    cancelTrial: "Cancela antes de que termine la prueba y no se te cobrará.",
    confirmingSubscription: "Confirmando tu suscripción a Briefly Pro…",
    monthly: "Mensual",
    yearly: "Anual",
    ...
    alreadyPro: "Ya tienes Briefly Pro.",
    themeSystem: "Sistema",
    themeLight: "Claro",
    themeDark: "Oscuro",
  },
  ja: {
    ...
    password: "パスワード",
    signingIn: "ログイン中…",
    signInTitle: "Brieflyにログイン",
    signInSubtitle: "既存のBriefly / Deeplyアカウントを使用してください。",
    ...
    monthly: "月額",
    yearly: "年額",
    chooseMonthly: "月額プランを選ぶ",
    chooseYearly: "年額プランを選ぶ",
    manageSubscription: "購読を管理",
    restorePurchases: "購入を復元",
    purchaseFailed: "購入に失敗しました",
    alreadyPro: "Briefly Proをご利用中です。",
    themeSystem: "システム",
    themeLight: "ライト",
    themeDark: "ダーク",
  },
  "zh-CN": {
    ...
    password: "密码",
    signingIn: "正在登录…",
    signInTitle: "登录 Briefly",
    signInSubtitle: "使用你现有的 Briefly / Deeply 账户。",
    signInFailed: "登录失败",
    ...
    cancelTrial: "试用结束前可随时取消，不会收费。",
    confirmingSubscription: "正在确认你的 Briefly Pro 订阅…",
    monthly: "按月",
    yearly: "按年",
    chooseMonthly: "选择月付",
    chooseYearly: "选择年付",
    ...
    purchaseFailed: "购买失败",
    alreadyPro: "你已经是 Briefly Pro 用户。",
    themeSystem: "跟随系统",
    themeLight: "浅色",
    themeDark: "深色",
  },
  "zh-TW": {
    ...
    password: "密碼",
    signingIn: "正在登入…",
    signInTitle: "登入 Briefly",
    signInSubtitle: "使用你現有的 Briefly / Deeply 帳戶。",
    signInFailed: "登入失敗",
    ...
    cancelTrial: "試用結束前可隨時取消，不會收費。",
    confirmingSubscription: "正在確認你的 Briefly Pro 訂閱…",
    monthly: "月繳",
    yearly: "年繳",
    chooseMonthly: "選擇月繳",
    chooseYearly: "選擇年繳",
    ...
    purchaseFailed: "購買失敗",
    alreadyPro: "你已經是 Briefly Pro 用戶。",
    themeSystem: "跟隨系統",
    themeLight: "淺色",
    themeDark: "深色",
  },
